 ...
 * @access      Public
 */
exports.getAllCards = async function (
  req: express.Request,
 ...
 * @access      Public
 */
exports.getAllCardsInStack = async function (
  req: express.Request,
  res: express.Response,
  next
) {
  ...
  const query =
    "SELECT * FROM cards WHERE inStack = (SELECT id FROM stacks WHERE slug = ?);";
...
exports.createCard = async function (
  ...
  const query =
    "INSERT INTO cards (question, answer, inStack) VALUES (?, ?, ?);";
 ...
 * @access      Public
 */
exports.updateCard = async function (
  req: express.Request,
  res: express.Response,
  next
) {
  ...
  const inStack = req.body.inStack;
  const query =
    "UPDATE cards SET question = ?, answer = ?, inStack = ? WHERE id = ?;";
 ...
 * @access      Public
 */
exports.deleteCard = async function (
  req: express.Request,
  res: express.Response,
  next
) {
